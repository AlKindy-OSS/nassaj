    ...
    <div className="flex min-h-0 flex-1 flex-col">
      <div className="flex-shrink-0 px-2 pb-2 pt-1">
        <button
          type="button"
          onClick={onCreate}
          className="flex h-[var(--control-height-touch)] w-full items-center justify-center gap-2 rounded-xl border border-dashed border-border/70 bg-muted/30 px-3 text-sm font-medium text-foreground transition-colors hover:border-border hover:bg-accent/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
