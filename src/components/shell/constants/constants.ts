...
export const TERMINAL_OPTIONS: ITerminalOptions = {
  cursorBlink: true,
  fontSize: 14,
  // Latin/code stays monospaced; the bundled Arabic face is a deliberate
  // fallback because common monospace fonts do not contain shaped Arabic.
  fontFamily: 'Menlo, Monaco, "Courier New", "IBM Plex Sans Arabic", monospace',
