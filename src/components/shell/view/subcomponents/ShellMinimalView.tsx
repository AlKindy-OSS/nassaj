// design-ok-file: امتداد لسطح الطرفية نفسه في Shell.tsx.
        ...
        <div className="absolute inset-x-0 bottom-14 z-20 border-t border-gray-700/80 bg-gray-900/95 p-3 backdrop-blur-sm md:hidden">
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between gap-2">
              <p className="text-xs text-gray-300">{t('minimal.openOrCopy')}</p>
              <button
                type="button"
