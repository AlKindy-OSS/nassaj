...
import { enableXtermArabic, ensureXtermFocusStyles } from '../utils/terminalStyles';
...
export function useShellTerminal({
  ...
  useEffect(() => {
    ...
    // Keep xterm's default DOM renderer. The Arabic character joiner makes each
    // Arabic run one DOM-rendered unit; WebGL would regress to isolated glyphs.
    nextTerminal.open(terminalContainerRef.current);
    const disableArabicSupport = enableXtermArabic(nextTerminal);
