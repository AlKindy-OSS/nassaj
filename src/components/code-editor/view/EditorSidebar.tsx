    ...
    <div ref={containerRef} className={`flex h-full min-w-0 ${editorExpanded ? 'flex-1' : ''}`}>
      {!editorExpanded && (
        <div
          ...
          title={t('editorSidebar.dragToResize')}
        >
      ...
      <div
        className={`h-full overflow-hidden border-s border-border ${useFlexLayout ? 'min-w-0 flex-1' : `min-w-[ flex-shrink-0${MIN_EDITOR_WIDTH}px]`}`}
