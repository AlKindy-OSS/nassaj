...
export default function CodeEditorHeader({
  ...
  return (
    <div className="app-top-rail flex min-w-0 flex-shrink-0 items-center justify-between gap-2 px-3">
      ...
      <div className="flex shrink-0 items-center gap-0.5">
        <DocumentShareButton projectId={shareProjectId} filePath={file.path} />
        {isMarkdownFile && (
          <button
            type="button"
