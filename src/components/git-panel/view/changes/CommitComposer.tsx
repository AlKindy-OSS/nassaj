      ...
      {isMobile && isCollapsed ? (
        <div className="border-b border-border/60 px-4 py-2">
          ...
          >
            ...
            <span>{t('git.commit.commitFiles', { count: selectedFileCount })}</span>
        ...
        <div className="border-b border-border/60 px-4 py-3">
          {isMobile && (
            <div className="mb-2 flex items-center justify-between">
              <span className="text-sm font-medium text-foreground">{t('git.commit.title')}</span>
              <button
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-border bg-background px-3 py-2 pe-20 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary/30 focus:outline-none focus:ring-2 focus:ring-primary/20"
              rows={3}
              onKeyDown={(event) => {
            ...
            <div className="absolute end-2 top-2 flex gap-1">
              <button
                ...
                title={t('git.commit.generateMessage')}
              >
                {isGeneratingMessage ? (
          ...
          <div className="mt-2 flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1 rounded-lg bg-primary px-3 py-1.5 text-sm text-primary-foreground transition-colors hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
            >
