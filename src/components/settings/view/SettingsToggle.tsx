    ...
    >
      <span
        className={cn(
          ...
          // B-373: الصنف غير المشروط + المشروط يضبطان `--tw-translate-x` نفسه،
          // فالفائز ترتيب الملف المولَّد لا القصد. تُكتب الحالتان بمتغيّرَي
          // ltr/rtl حصراً (نفس صياغة DarkModeToggle).
          checked
            ? 'ltr:translate-x-[22px] rtl:-translate-x-[22px] bg-card'
