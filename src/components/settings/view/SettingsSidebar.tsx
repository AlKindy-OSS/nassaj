        ...
        <nav className="flex flex-col gap-1 p-3">
          {navItems.map((item) => {
            ...
            return (
              <button
                key={item.id}
                // مقبضٌ ثابت للتحقّق البصري الآلي (`scripts/settings-shots.mjs`).
                // اللصيقة المرئية تتغيّر بلغة الواجهة، فالاختيار بها يجعل اللقطات
                // تعمل بالعربية وتفشل بالإنجليزية.
