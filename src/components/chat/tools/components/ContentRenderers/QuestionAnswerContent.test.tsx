...
// NOTE: since B-100 only null/undefined entries are dropped. Entries that are
// non-null but unparseable are rendered as raw text rather than deleted — the
// behaviour is pinned in QuestionAnswerContent.degraded.test.tsx. This case
// remains here for its original purpose: proving none of them throw.
test('a question entry that is null / non-object / lacks a string prompt never throws', () => {
  assert.doesNotThrow(() =>
    renderMalformed({
      questions: [
        null,
