        ...
        {tasks.map((task) => {
          ...
          return (
            ...
            >
              ...
              {/* عنوان المهمة نصّ حرّ: يحسم اتجاهه بنفسه فلا يجرّه رقم `#15`
                  اللاتيني الذي يسبقه ولا لغة الواجهة. */}
              <span
                className={`flex-1 truncate text-xs ${config.textClass}`}
                dir={resolveTextDirection(task.subject) ?? undefined}
              >
                {task.subject}
              </span>
