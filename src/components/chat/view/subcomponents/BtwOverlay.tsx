...
const BTW_ERROR_CODE_KEYS: Record<string, string> = {
  ...
  // B-1084: model returned no visible text (thinking-only or empty result).
  empty_response: 'btw.errors.empty_response',
...
interface BtwOverlayProps {
  state: BtwState | null;
  onClose: () => void;
  /** Provider capability: Codex answers side queries but cannot promote them. */
