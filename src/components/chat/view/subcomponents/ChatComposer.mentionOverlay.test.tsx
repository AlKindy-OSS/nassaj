 ...
 * حروف أخرى. العينة الاصطناعية أدناه تحفظ هذا الحد البنيوي بلا نشر corpus تشغيل.
 *
...
describe('ChatComposer — طبقة المرآة تطابق اتجاه الحقل حرفياً', () => {
  ...
  // B-370: `dir=auto` يحسب الاتجاه من قيمة الحقل لا من الـplaceholder،
  // والقيمة الفارغة تُحسم `ltr` فيرتدّ نصّ الـplaceholder العربي إلى يسار الصندوق.
  // عند الفراغ تُسقَط السِمة من الطبقتين معاً فيرثان `rtl` من المستند.
  it('الحقل الفارغ يُسقط dir فيرث اتجاه المستند، والمرآة تتبعه', () => {
