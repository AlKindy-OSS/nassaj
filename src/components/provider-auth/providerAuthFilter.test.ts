...
describe('resolveFallbackProvider — auto-reset never lands on a dead end', () => {
  ...
  it('skips every globally disabled provider even when it is the only one installed', () => {
    // Pre-fix this returned a disabled provider — one absent from the picker and
