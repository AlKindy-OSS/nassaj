    ...
    <div className="space-y-6">
      <div className="mb-6 text-center">
        <h2 className="mb-2 text-2xl font-bold text-foreground">
          {t('onboarding.agents.title', { defaultValue: 'Connect Your AI Agents' })}
        </h2>
        <p className="text-muted-foreground">
          {t('onboarding.agents.subtitle', {
            defaultValue: 'Login to one or more AI coding assistants. All are optional.',
          })}
        </p>
      </div>
      ...
      <div className="pt-2 text-center text-sm text-muted-foreground">
        <p>
          {t('onboarding.agents.footerNote', {
            defaultValue: 'You can configure these later in Settings.',
          })}
        </p>
      </div>
    </div>
