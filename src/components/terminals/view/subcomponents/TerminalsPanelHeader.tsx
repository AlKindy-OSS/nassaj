            ...
            <>
              ...
              {isEditing ? (
                <input
                  ...
                  className="h-[var(--control-height-compact)] min-w-0 flex-1 rounded-md border border-border bg-background px-2 py-1 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                />
              ) : (
                <button
                  type="button"
                  ...
                  className="group flex h-[var(--control-height-compact)] min-w-0 items-center gap-1.5 rounded-md px-1 py-0.5 text-start hover:bg-accent/60"
                >
              ...
              <>
                <Tooltip content={t('panel.save')} position="bottom">
                  <button
                    ...
                    className="flex h-[var(--control-height-compact)] w-[var(--control-height-compact)] items-center justify-center rounded-lg text-muted-foreground hover:bg-accent/80 hover:text-foreground"
                  >
              ...
              <>
                ...
                <Tooltip content={t('panel.deleteHint')} position="bottom">
                  <button
                    ...
                    className="flex h-[var(--control-height-compact)] w-[var(--control-height-compact)] items-center justify-center rounded-lg text-muted-foreground hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400"
                  >
