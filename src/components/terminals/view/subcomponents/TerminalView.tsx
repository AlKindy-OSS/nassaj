// design-ok-file: سطح الطرفية داكن في الوضعين — انظر Shell.tsx.
...
export default function TerminalView({ terminal, isActive, onRequestListRefresh }: TerminalViewProps) {
  ...
  const { terminalContainerRef, state, truncated, exitInfo, errorMessage, reconnect, focus } = useTerminalConnection({
