  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex w-full items-center justify-between gap-2 rounded-lg border border-border bg-card px-3 py-2 text-start text-sm text-foreground hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
      >
        ...
        <ChevronsUpDown className="h-4 w-4 flex-shrink-0 text-muted-foreground" aria-hidden />
      </button>
