  ...
  },
  {
    ...
    settings: {
      ...
      "boundaries/elements": [
        ...
        { type: "backend-shared-utils", pattern: ["server/shared/utils.{js,ts}","server/shared/frontmatter.ts","server/shared/claude-cli-path.ts","server/shared/cli-executable-path.ts","server/shared/codex-executable.js","server/services/image-signature.js","server/services/svg-sanitizer.js"], mode: "file" },
