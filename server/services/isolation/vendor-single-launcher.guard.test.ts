...
const VENDOR_AGENT_LAUNCHER_REGISTRY: ReadonlyArray<{
  ...
  {
    file: 'server/modules/turn-supervisor/adapters/extended-cli-adapter.ts',
    sanitized: true,
    note: 'OpenCode ephemeral supervisor launcher; sanitizes its capture-only process environment.',
  },
];
