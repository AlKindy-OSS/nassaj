...
import { DEFAULT_DATABASE_PATH } from './modules/database/database-path.js';
...
// The default is shared from modules/database/database-path.js so every consumer agrees.
