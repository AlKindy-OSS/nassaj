 ...
 * as used elsewhere in the server suite. CI runs Node 22, so this fixture uses
 * its `namedExports`/`defaultExport` contract (Node 24 warns but still supports it).
