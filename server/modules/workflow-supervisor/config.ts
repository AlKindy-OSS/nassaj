 ...
 * supervisor reads them from. A strict file-only contract: the two processes
 * share ONLY these files, never a socket or DB handle. Overridable via WORKFLOW_SUPERVISOR_STATE_DIR for tests.
 *
 * Layout:
