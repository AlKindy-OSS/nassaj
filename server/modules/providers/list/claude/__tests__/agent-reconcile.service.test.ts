...
const COMPLETED_UNDELIVERED_ENQUEUE = row(
  '{"type":"queue-operation","operation":"enqueue","timestamp":"2026-07-10T17:51:53.638Z","sessionId":"00000005-0000-4000-8000-000000000005","content":"<task-notification>\\n<task-id>af485a27dc52b445a</task-id>\\n<tool-use-id>toolu_01QmESQChSWFCpUFzHY1dzuJ</tool-use-id>\\n<output-file>/tmp/claude-1000/-home-dev-workspace-nassaj/00000005-0000-4000-8000-000000000005/tasks/af485a27dc52b445a.output</output-file>\\n<status>completed</status>\\n<summary>Agent \\"Anthropic ToS third-party client research\\" finished</summary>\\n<note>A task-notification fires each time this agent stops with no live background children of its own. The user can send it another message and resume it, so the same task-id may notify more than once.</note>\\n<result>*Please answer in the same language as the question.*</result>\\n<usage><subagent_tokens>29468</subagent_tokens><tool_uses>0</tool_uses><duration_ms>2063</duration_ms></usage>\\n</task-notification>"}',
);

/** VERBATIM — a `remove` row. Measured: `remove` is NOT delivery. */
const REMOVE_ROW = row(
  '{"type":"queue-operation","operation":"remove","timestamp":"2026-07-26T02:14:17.680Z","sessionId":"00000006-0000-4000-8000-000000000006","content":"<task-notification>\\n<task-id>b4qftb123</task-id>\\n<tool-use-id>toolu_012xA4RKRRXNdB5ywnX2hyuj</tool-use-id>\\n<output-file>/tmp/claude-1000/-home-dev-workspace-nassaj/00000006-0000-4000-8000-000000000006/tasks/b4qftb123.output</output-file>\\n<status>completed</status>\\n<summary>Background command \\"Final lint run\\" completed (exit code 0)</summary>\\n</task-notification>"}',
);

/** VERBATIM shape — a contentless `dequeue` row (922 of these exist). */
const DEQUEUE_ROW = row(
  '{"type":"queue-operation","operation":"dequeue","timestamp":"2026-07-26T09:26:36.500Z","sessionId":"00000001-0000-4000-8000-000000000001","content":""}',
);
