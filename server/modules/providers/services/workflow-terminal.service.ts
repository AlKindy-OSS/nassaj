 ...
 * results than starts:
 *
 *   wf_synthetic_f66564da-ad8 → journal: 5 `started`, 2 `result`
 ...
 * ADR-053, incident wf_synthetic_ef5ba242) stays intact.
 *
 * TERMINAL vs NON-TERMINAL STATUSES (measured frequencies across production-shaped synthetic transcripts)
 * -------------------------------------------------------------------------------
