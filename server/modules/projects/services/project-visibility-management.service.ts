 ...
 * Membership management below survives: project_members still records who owns
 * a project (orphan recovery, the sidebar "my projects" filter), it just no
 * longer gates who may READ a project — everyone on the team may.
 */
