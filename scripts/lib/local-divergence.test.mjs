...
test('classifyDivergence: dependency manifests are dependency (rukhaimi allowScripts)', () => {
    const r = classifyDivergence({
...
test('classifyDivergence: precedence code > dependency > overlayable', () => {
    // A rukhaimi-shaped mix: overlayable hub, added .gitignore, dependency bump,
